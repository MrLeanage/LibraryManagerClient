...
public class AlertPopUp {
    ...
    public static void sentSuccessfully(String text){
        Alert msg = new Alert(Alert.AlertType.INFORMATION);
        msg.setTitle("Successfull..");
        msg.setHeaderText(null);
    ...
    public static Optional<ButtonType> sessionExpired(){
        Alert alert = new Alert(Alert.AlertType.ERROR);
        alert.setTitle("Session has been Expired");
        alert.setHeaderText(null);
        alert.setContentText("You will logout from session now!");
        Optional<ButtonType> action = alert.showAndWait();
        return action;
    }
}
